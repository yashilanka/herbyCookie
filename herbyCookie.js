...
(function ( $ ) {
    ...
    $.fn.herbyCookie = function( options ) {
        ...
        if(!(herbyConsent == "accept")){
            $("body").append(herbyHtml), $("head").append(herbyCss);
        };
